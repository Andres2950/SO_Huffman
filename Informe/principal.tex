...
\begin{enumerate}
  \item Descargue el código fuente del programa. Puede hacerlo de las dos siguientes formas:
    ...
    \end{itemize}
  \item Descomprima el archivo .zip descargado de la manera que prefiera, puede ser utilizando el comando \texttt{unzip main.zip}.
  \item Al extraer el archivo verá la carpeta \texttt{SO\_Huffman-main}, muévase a ella utilizando el comando \texttt{cd SO\_Huffman-main}. Posteriormente podrá observar la estructura de organización similar a la figura \ref{fig:estructura}.
